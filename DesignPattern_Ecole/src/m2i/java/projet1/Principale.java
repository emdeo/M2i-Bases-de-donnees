...
public class Principale {
	...
	public static void main(String[] args) {
		 ...
		 * ETAPE 5 - Instancier les tables (insérer des valeurs prédéfinies)
		 * ETAPE 6 - Insérer une ligne dans une table
		 * ETAPE 7 - Afficher une ligne d'une table (id en paramètre)
		 * ETAPE 8 - Lire toutes les ligne d'une table
		 * ETAPE 9 - Modifier les informations de la ligne d'une table
		 * ETAPE 10 - Supprimer une ligne d'une table (id en paramètre)
		 * ETAPE 11 - Supprimer un élève de la table "Eleve" et toutes les notes correspondantes dans la table "Note"
